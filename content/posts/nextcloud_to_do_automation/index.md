...
I keep a task list in a [todo.txt](http://todotxt.org/) format in
[Nextcloud](https://nextcloud.com/). They are simply kept as two text
...
[WebDAV](https://tools.ietf.org/html/rfc2518). So, I should be able to
make a Python script to do this, using
[requests](https://pypi.org/project/requests/). A more full-featured
...
In [todo.txt](http://todotxt.org/), tasks are marked as done by
...
to use [ETags](https://tools.ietf.org/html/rfc7232).

For the structure of the script, I at first wrote it using the
[Plumbum CLI
application](https://plumbum.readthedocs.io/en/latest/cli.html), but later found that it was adding so little benefit I
